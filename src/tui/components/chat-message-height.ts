 ...
 * user messages that opened a turn (not on a steer), and up to three
 * `[open <host>]` chips when the message carries URLs. They all share a row, so this stays one row and
