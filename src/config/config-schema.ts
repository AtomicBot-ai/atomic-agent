...
export interface UserManagedLocalLlmConfig {
   ...
   * Default `true` since config v38. Older files stored an unused
...
// v38: `localModels.managed.autoUpdate` is wired to managed start
// (TUI auto-start / CLI `models start`) and defaults to `true`. Pre-v38
...
/** Pre-v38 `autoUpdate: false` was a dead default; force the live default. */
const MANAGED_AUTO_UPDATE_DEFAULTS_VERSION = 38;
