...
const HELP =
  [
    ...
    "",
    "Remote channels:",
    "  serve boots the same runtime the TUI does, so an enabled Telegram or Discord channel",
    "  (and every enabled swarm bot) runs in this process too — this is how the bots keep",
    "  answering with no TUI open. Nothing here restarts the process for you.",
