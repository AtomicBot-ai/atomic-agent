...
We run local models on our own TurboQuant `llama.cpp` ([`AtomicBot-ai/atopmic-llama-cpp-turboquant-nightly`](https://github.com/AtomicBot-ai/atopmic-llama-cpp-turboquant-nightly)):
