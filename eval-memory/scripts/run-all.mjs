...
//
// Runs the experiments in cost order: E1 → E3 → E2 → E4 (cheapest
// signal first, see PLAN.md § "Run order and gates").
//
// Failure semantics:
...
//             E2 and E4; a failure here predicts noise downstream but
//             the runs themselves are still informative).
